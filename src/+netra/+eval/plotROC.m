...
nL = max(nC, 2);                          % legend rows (the notes need two)
legH = 0.035 * nL + 0.02;
...
text(lg, 1, 1 - 0.5 / nL, sprintf('shaded target: Se >= %.0f%%, Sp >= %.0f%%', 100 * o.Target(1), ...
    100 * o.Target(2)), 'FontSize', 9, 'Color', C.muted, 'FontName', font, ...
    'HorizontalAlignment', 'right', 'VerticalAlignment', 'middle');
text(lg, 1, 1 - 1.5 / nL, sprintf('zoomed: 1 - Sp 0-%.1f, Se %.1f-1', xl(2), yl(1)), ...
