...
args = {'InitialLearnRate', o.LearnRate, ...
    'MaxEpochs', o.Epochs, ...
...
% keep the best-validation network; the option value was renamed from
% 'best-validation-loss' to 'best-validation' when trainnet arrived
try
    opts = trainingOptions('adam', args{:}, 'OutputNetwork', 'best-validation');
catch
    try
        opts = trainingOptions('adam', args{:}, 'OutputNetwork', 'best-validation-loss');
    catch
